namespace DumbML {
    public class ReduceMax : Operation {
        int[] axis;
        int[] _shapeActual;

        public ReduceMax(Operation op, params int[] axis) {
            // TODO validate axis
        ...
        /// </summary>
        public ReduceMax(Operation op, Operation matchShape) {
        ...
        public override void Forward(ITensorBuffer[] inputs, ITensorBuffer result) {
            ...
            BLAS.Engine.Compute.ReduceMax(inputs[0], axis, result);
        }
        ...
        public override Operation[] BuildBackwards(Operation[] inputs, Operation output, Operation error) {
            ...
            Operation mask = new ElementwiseEquals(inputs[0], output);
            mask = new Cast(mask, DType.Float);
